...
#  Updated: 2026/02/13 18:13:15 by fcaval          ###   ########.fr        #
#                                                                           #
# ************************************************************************* #
...
class TransformStage:
    ...
    def process(self, data: Any) -> Any:
        ...
        elif isinstance(data, dict) and not "sensor" in data:
...
# ************************************************************************* #
    ...
    with redirect_stdout(io.StringIO()):
        ...
        result_c = stream_pipeline.process(result_b)

    print()
    end_time = time.time()
    result_time = end_time - start_time
    print("Chain result: 100 records processed through 3-stage pipeline")
    print(f"Performance: 95% efficiency, {result_time:.5f}s total processing time")
    print()
